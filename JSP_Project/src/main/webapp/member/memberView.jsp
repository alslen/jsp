...
<div align = "right">
	...
	/ <a href="../border/list.jsp">게시판</a>
</div>
  <h2>회원정보 수정</h2>
  <form action="memberUpdatePro.jsp" method="post" id="frm">
  <input type="hidden" name="userid" id="userid" value="<%=sid %>"> <!-- member.getUserid()를 넣어도 상관x -->
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" value="<%=member.getPwd()%>" name="pwd">
    </div>
	...
	<div class="form-check-inline">
	 ...
	 <!-- input의 라디오버튼을 찾아서 admin의 값이 0이면 "일반회원" 체크, admin의 값이 1이면 "관리자"가 체크 되어있음 --> 
	<script>
